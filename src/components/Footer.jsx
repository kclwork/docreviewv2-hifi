...
const FOOTER_COLUMNS = [
  {
    heading: 'Company',
    links: ['About Us', 'Blog', 'Careers', 'News & Press', 'Partners', 'Meet IDI'],
  },
  {
    heading: 'Solutions',
    links: ['Collections', 'Business Services', 'Commerce & Agreements', 'Employment', 'Intellectual Property', 'Add-on Coverage'],
  },
  {
    heading: 'Legal Help',
    links: ['Estate Planning', 'Family Law', 'Real Estate', 'Reviews', 'Traffic & Accidents', 'Add-on Coverage'],
  },
  {
    heading: 'Support',
    links: ['Help Center', 'Contact Us', 'Find a Lawyer', 'Family Law', 'Traffic & Accidents', 'Become an Associate'],
  },
]
      ...
      <div className={styles.inner}>
        <div className={styles.top}>
          <div className={styles.brand}>
            ...
            <p className={styles.tagline}>
              Sign up for our newsletter for tips, advice, and updates.
            </p>
            <div className={styles.emailRow}>
              ...
              />
              <button className={styles.emailBtn} aria-label="Subscribe">→</button>
            </div>
          </div>
        ...
        <div className={styles.bottom}>
          ...
          <div className={styles.bottomRight}>
            <span className={styles.appLabel}>App Store</span>
            <span className={styles.appLabel}>Google Play</span>
          </div>
        </div>
