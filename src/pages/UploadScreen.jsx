...
import uploadStyles from './UploadScreen.module.css'
      ...
      <main>
        ...
        <section className={styles.widget}>
          <div className={styles.inner}>
            ...
            {/* Right column — uploaded file state */}
            <div className={styles.widgetRight}>
              <div className={styles.uploadCard}>
                <div className={styles.uploadZone}>
                  <div className={uploadStyles.confirmedStack}>
                    <div className={uploadStyles.checkCircle}>
                      <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15 4.5L7 13l-4-4" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </div>
                    <span className={uploadStyles.fileName}>Service_Contract_2026.doc</span>
                    <span className={uploadStyles.fileSize}>84 KB</span>
                    <button className={uploadStyles.changeFile} onClick={handleChangeFile}>
                      Change file
                    </button>
                    <input
                      ref={fileInputRef}
                ...
                <div className={uploadStyles.reviewWrap}>
                  <button className={uploadStyles.reviewBtn} onClick={handleReview}>
                    Review my document
                  </button>
                </div>
              </div>
