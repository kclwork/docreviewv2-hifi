...
import ChatboxDrawer from '../../components/mobile/ChatboxDrawer.jsx'
import ChatboxFAB from '../../components/mobile/ChatboxFAB.jsx'
import {
  MobileMktHero,
  MobileElleFaq,
  MobileBenefits,
...
const ELLE_RESPONSE = "I've reviewed your wedding contract and found a few potential issues. First, the cancellation clause in Section 4 allows the photographer to cancel at any time without penalty to them. I'd recommend negotiating a mutual cancellation clause before signing."

const EMAIL_RE = /^[^\s@]+@[^\s@]+\.[^\s@]+$/

export default function MobileV2FullReview() {
  ...
  // Chatbox state machine: 'default' | 'email-gate' | 'elle-response'
  ...
  function handleSubmitQuery(text) {
    setSubmittedQuery(text)
    setChatStep('email-gate')
  }
